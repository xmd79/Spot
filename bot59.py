...
def perform_single_iteration_analysis(client):
    ...
    # Step 3: Analyze Pythagorean Harmonics for 1-minute timeframe
    print("\n3. Analyzing Pythagorean Harmonics for 1-minute timeframe...")
    ...
    # Step 4: Analyze Pythagorean Harmonics for 15-second timeframe
    print("\n4. Analyzing Pythagorean Harmonics for 15-second timeframe...")
    ...
    # Step 5: Analyze all specified conditions
    ...
    # Condition 9: Argmin More Recent than Argmax (15s)
    print("\n--- Condition 9: Argmin More Recent than Argmax (15s) ---")
    ...
    # Condition 10: Argmin More Recent than Argmax (1m)
    print("\n--- Condition 10: Argmin More Recent than Argmax (1m) ---")
    ...
    # Condition 11: Lowest SMA200 More Recent than Highest SMA200 (1m)
    print("\n--- Condition 11: Lowest SMA200 More Recent than Highest SMA200 (1m) ---")
    ...
    # Condition 12: Close Below Middle Threshold (1m)
    print("\n--- Condition 12: Close Below Middle Threshold (1m) ---")
    ...
    # Condition 13: Lowest SMA200 More Recent than Highest SMA200 (15s)
    print("\n--- Condition 13: Lowest SMA200 More Recent than Highest SMA200 (15s) ---")
    ...
    # Condition 14: Close Below Middle Threshold (15s)
    print("\n--- Condition 14: Close Below Middle Threshold (15s) ---")
    ...
    # Condition 15: Volume Bullish Dominance (1m)
    print("\n--- Condition 15: Volume Bullish Dominance (1m) ---")
    ...
    # Condition 16: Volume Bullish Dominance (15s)
    print("\n--- Condition 16: Volume Bullish Dominance (15s) ---")
    ...
    # Step 7: Cleanup for next iteration
...
def main():
    ...
    print("   - Close Below Middle Threshold (1m)")
    print("   - Lowest SMA200 More Recent than Highest SMA200 (15s)")
    print("   - Close Below Middle Threshold (15s)")
    print("   - Volume Bullish Dominance (1m)")
    print("   - Volume Bullish Dominance (15s)")
