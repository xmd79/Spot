...
# ------------------ Local Dip/Top Detection using argmin/argmax ------------------
...
def analyze_local_dip_condition(client, symbol, lookback=500):
    ...
    try:
        ...
        # Determine which occurred more recently (higher index = more recent)
        ...
        print(f"Most Recent: {'Lowest Low (Dip)' if dip_more_recent else 'Highest High (Top)'}")
