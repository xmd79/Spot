...
# Updated configurable conditions - Now 21 conditions as specified
CONFIG = {
    "conditions": {
    ...
    "min_conditions_met": 21  # ALL 21 conditions must be met to trigger a trade
}
...
def perform_single_iteration_analysis(client):
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - 21 TRIGGERS")
    ...
    print("\n2. Analyzing all 21 specified trading conditions...")
    
    conditions_met = 0
    total_conditions = 21  # Total number of conditions
...
def main():
    ...
    print("=== ENHANCED BTCUSDC TRADING BOT - 21 TRIGGERS ===")
    ...
    print("4. Analyze all 21 specified trading conditions:")
    ...
    print("5. Execute trade if ALL 21 conditions are met")
    ...
    print("\nEnhanced Features:")
    print("- Now 21 selected triggers (added Momentum 3m/5m, FFT 3m/5m, Volume 3m/5m)")
