...
CONFIG = {
    "conditions": {
        ...
        "pythagorean_harmonics_up_15s": True  # 15s Pythagorean Harmonics (NEW)
    },
...
def perform_single_iteration_analysis(client):
    """Perform single iteration analysis with all conditions including Pythagorean Harmonics."""
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - PYTHAGOREAN HARMONICS")
    ...
    # Step 1: Analyze Pythagorean Harmonics for 1-minute timeframe
    print("\n1. Analyzing Pythagorean Harmonics for 1-minute timeframe...")
    ...
    # Step 2: Analyze Pythagorean Harmonics for 15-second timeframe
    print("\n2. Analyzing Pythagorean Harmonics for 15-second timeframe...")
    ...
    # Condition 13: Pythagorean Harmonics Up (1m)
    print("\n--- Condition 13: Pythagorean Harmonics Up (1m) ---")
    ...
    # Condition 14: Pythagorean Harmonics Up (15s) - NEW
    print("\n--- Condition 14: Pythagorean Harmonics Up (15s) ---")
...
def main():
    ...
    print("=== ENHANCED BTCUSDC TRADING BOT - PYTHAGOREAN HARMONICS ===")
    ...
    print("4. Analyze 14 configurable trading conditions including:")
    ...
    print("   - NEW: Pythagorean Harmonics Up (15s)")
    ...
    print("- Pythagorean Harmonics analysis for both 1m and 15s timeframes")
