...
# New configurable conditions - Updated to include 12 conditions (8 original + 4 new)
CONFIG = {
    "conditions": {
...
def perform_single_iteration_analysis(client):
    """Perform single iteration analysis with 12 conditions (8 original + 4 new)."""
    global trade_active, trade_info
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - 12 SPECIFIED TRIGGERS")
    ...
    # Step 5: Analyze 12 specified conditions
    print("\n5. Analyzing 12 specified trading conditions...")
    
    conditions_met = 0
    total_conditions = 12  # Total number of conditions (updated to 12)
...
def main():
    ...
    print("=== ENHANCED BTCUSDC TRADING BOT - 12 SPECIFIED TRIGGERS ===")
    ...
    print("5. Analyze 12 specified trading conditions:")
    ...
    print("\nEnhanced Features:")
    print("- 12 specified triggers (8 original + 4 new)")
