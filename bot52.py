...
PROFIT_TARGET_PERCENT = 0.25  # Changed from 0.75% to 0.25% as requested
...
# New configurable conditions - Updated to include 13 conditions (9 original + 4 new)
CONFIG = {
    "conditions": {
...
def find_recent_extrema(df, lookback=500):
    """
    Find the most recent extrema (argmin or argmax) in the last N values.
...
def apply_pythagorean_harmonics(extrema_data, timeframe='1m'):
    ...
    try:
        ...
        for triple in PYTHAGOREAN_TRIPLES:
            ...
            # Calculate the distance between our c and the scaled triple's c
...
def check_trade_status(client):
    ...
    try:
        ...
        # Calculate target price for 0.25% clean profit after fees (changed from 0.75%)
        # Target price = entry_price * (1 + 0.25% + 0.22% fee) = entry_price * 1.0047
...
def perform_single_iteration_analysis(client):
    """Perform single iteration analysis with 13 conditions (9 original + 4 new)."""
    global trade_active, trade_info
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - 13 SPECIFIED TRIGGERS")
    ...
    # Step 5: Analyze 13 specified conditions
    print("\n5. Analyzing 13 specified trading conditions...")
    
    conditions_met = 0
    total_conditions = 13  # Total number of conditions (updated to 13)
    ...
    # Condition 10: Current Close Below Middle Threshold (15s)
    print("\n--- Condition 10: Current Close Below Middle Threshold (15s) ---")
    ...
    # Condition 11: Argmin More Recent than Argmax (15s)
    print("\n--- Condition 11: Argmin More Recent than Argmax (15s) ---")
    ...
    # Condition 12: Current Close Below Middle Threshold (1m)
    print("\n--- Condition 12: Current Close Below Middle Threshold (1m) ---")
    ...
    # Condition 13: Argmin More Recent than Argmax (1m)
    print("\n--- Condition 13: Argmin More Recent than Argmax (1m) ---")
    ...
    if conditions_met == CONFIG['min_conditions_met'] and not trade_active:
        ...
        if buy_result['success']:
            ...
            if current_price:
                ...
                # Calculate target price with fees included (0.25% profit target)
...
def main():
    ...
    print("=== ENHANCED BTCUSDC TRADING BOT - 13 SPECIFIED TRIGGERS ===")
    ...
    print("5. Analyze 13 specified trading conditions:")
    ...
    print("\nEnhanced Features:")
    print("- 13 specified triggers (9 original + 4 new)")
    print("- Take profit target changed to 0.25% (from 0.75%)")
