...
# CONFIGURATION UPDATED: Added volume conditions and new precise stoch/rsi condition
CONFIG = {
    "conditions": {
        ...
        "stoch_rsi_precise_30m": True,  # NEW
    },
    "min_conditions_met": 12  # Updated to 12 active conditions
}
...
try:
    while True:
        ...
        conditions_status = {
            ...
            "stoch_rsi_precise_30m": False, # NEW
        }
