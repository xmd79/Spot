...
def analyze_spectral_phase_reversal(candles_1m):
    ...
    try:
        ...
        # Update condition_met based on reversal detection
        if dip_reversal and not condition_met:
            condition_met = True
            print(f"DIP REVERSAL CONFIRMED - Condition changed from False to True")
        elif cycle_intensity > 90 and condition_met:
            condition_met = False
            print(f"TOP REVERSAL CONFIRMED - Condition changed from True to False")
        ...
        print(f"Coherence: {phase_coherence:.3f}")  # Fixed variable name
        ...
        return {
            ...
            "resonance": resonance,
            "coherence": phase_coherence,  # Fixed variable name
