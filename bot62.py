...
# Updated configurable conditions - Now 15 conditions as specified
CONFIG = {
    "conditions": {
    ...
    "min_conditions_met": 15  # ALL 15 conditions must be met to trigger a trade
}
...
def perform_single_iteration_analysis(client):
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - 15 TRIGGERS")
    ...
    print("\n2. Analyzing all 15 specified trading conditions...")
    
    conditions_met = 0
    total_conditions = 15  # Total number of conditions
    ...
    # Condition 4: Momentum Positive (1m) - Changed from negative to positive
    ...
    # Conditions 6-8: SMA200 Lowest More Recent (1m, 3m, 5m)
    for i, (tf, sma_data) in enumerate([('1m', sma200_1m), ('3m', sma200_3m), ('5m', sma200_5m)], start=6):
    ...
    # Conditions 9-11: Close Below Middle Threshold (1m, 3m, 5m)
    for i, (tf, thresholds_data) in enumerate([('1m', thresholds_1m), ('3m', thresholds_3m), ('5m', thresholds_5m)], start=9):
    ...
    # Condition 12: Volume Bullish Dominance (1m)
    print("\n--- Condition 12: Volume Bullish Dominance (1m) ---")
    volume_met = False
    if 'error' not in volume_1m:
        volume_met = volume_1m['bullish_dominance']
        condition_results['Volume Bullish Dominance (1m)'] = volume_met
        ...
        print(f"Bullish Dominance: {volume_met}")
    ...
    # Conditions 13-15: Argmin More Recent (1m, 3m, 5m)
...
def main():
    ...
    print("=== ENHANCED BTCUSDC TRADING BOT - 15 TRIGGERS ===")
    ...
    print("4. Analyze all 15 specified trading conditions:")
    ...
    print("5. Execute trade if ALL 15 conditions are met")
    ...
    print("\nEnhanced Features:")
    print("- Now 15 selected triggers (added RSI 1m, Momentum, SMA200 3m/5m, Argmin 5m)")
