...
# Updated configurable conditions - Now 9 conditions as specified
CONFIG = {
    "conditions": {
...
def main():
    ...
    print("4. Analyze all 9 specified trading conditions:")
    ...
    print("5. Execute trade if ALL 9 conditions are met")
    ...
    print("\nEnhanced Features:")
    print("- Now 9 selected triggers as specified")
