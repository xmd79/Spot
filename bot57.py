...
# New configurable conditions - Updated to include 13 conditions (original 17 - 4 removed)
CONFIG = {
    "conditions": {
...
def perform_single_iteration_analysis(client):
    """Perform single iteration analysis with 13 conditions (original 17 - 4 removed)."""
    global trade_active, trade_info
    ...
    # Condition 2: FFT Forecast Up (1m)
    print("\n--- Condition 2: FFT Forecast Up (1m) ---")
    ...
    # Condition 3: FFT Forecast Up (15s)
    print("\n--- Condition 3: FFT Forecast Up (15s) ---")
    ...
    # Condition 4: Pythagorean Harmonics Up (1m)
    print("\n--- Condition 4: Pythagorean Harmonics Up (1m) ---")
    ...
    # Condition 5: Pythagorean Harmonics Up (15s)
    print("\n--- Condition 5: Pythagorean Harmonics Up (15s) ---")
    ...
    # Condition 8: Argmin More Recent than Argmax (15s)
    print("\n--- Condition 8: Argmin More Recent than Argmax (15s) ---")
    ...
    # Condition 10: Lowest SMA200 More Recent than Highest SMA200 (1m)
    print("\n--- Condition 10: Lowest SMA200 More Recent than Highest SMA200 (1m) ---")
    ...
    # Condition 11: Current Close Below SMA200 (1m)
    print("\n--- Condition 11: Current Close Below SMA200 (1m) ---")
    ...
    # Condition 12: Lowest SMA200 More Recent than Highest SMA200 (15s)
    print("\n--- Condition 12: Lowest SMA200 More Recent than Highest SMA200 (15s) ---")
    ...
    # Condition 13: Current Close Below SMA200 (15s)
    print("\n--- Condition 13: Current Close Below SMA200 (15s) ---")
...
def main():
    ...
    print("\nEnhanced Features:")
    print("- 13 specified triggers (original 17 - 4 removed)")
