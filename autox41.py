...
try:
    while True:
        ...
        if position_open:
            ...
            # UPDATED PRINT STATEMENT TO REFLECT CLEAN PROFIT
            ...
            if entry_price > Decimal('0') and target_price > entry_price:
                ...
                # UPDATED TEXT
                print(f"Total Price Move Required (Net {PROFIT_TARGET_PERCENT}% + Fees {TOTAL_FEE_PERCENT}%): {entry_to_target_pct:.2f}%")
