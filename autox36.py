...
# Removed: sine_wave_oscillator_15sec, stoch_15s_oversold, stoch_1m_oversold
CONFIG = {
    "conditions": {
        "momentum_positive_1m": True,
        "momentum_positive_15sec": True,
        "linear_regression_channel_break": True, # NOW USING 15s TF
        "aroon_only_signal": True,
        # "sine_wave_oscillator_15sec": True,     # REMOVED
        # "stoch_15s_oversold": True,            # REMOVED
        # "stoch_1m_oversold": True,              # REMOVED
        "thresholds_15sec": True,
        "volume_bullish_1min": True,
        "volume_bullish_15sec": True,
    },
    "min_conditions_met": 7  # Updated from 10 to 7 (3 conditions removed)
}
...
try:
    while True:
        ...
        # Condition 5: Thresholds 15sec (Moved up in numbering since 6,7,8 removed)
