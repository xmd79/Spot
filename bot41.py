...
def perform_single_iteration_analysis(client):
    ...
    # Oscillator 1: 15-second timeframe (1200 values) - Changed from 1m to 15s
    ...
    # Oscillator 2: 15-second timeframe (500 values) - Changed from 1m to 15s
    ...
    # Condition 5: Harmonic Oscillator 1 (15s 1200) - Changed from 1m to 15s
    ...
    # Condition 6: Harmonic Oscillator 2 (15s 500) - Changed from 1m to 15s
...
def main():
    ...
    print("3. Analyze harmonic oscillators (15s 1200, 15s 500, 15s momentum)")
    ...
    print("- Three separate oscillators (15s 1200, 15s 500, 15s momentum)")
    ...
    print("- Both oscillators now use artificial 15-second timeframe derived from 1-minute data")
    print("="*60)
