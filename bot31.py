...
def perform_single_iteration_analysis(client):
    ...
    conditions_met = 0
    total_conditions = 6  # Updated to 6 conditions
    condition_details = {}
    ...
    # Condition 5: Momentum Increasing
    print("\n--- Condition 5: Momentum Trend (Increasing) ---")
    _, _, _, momentum_increasing, momentum_decreasing = calculate_momentum_trend(candles, '15s', MOMENTUM_PERIOD, MOMENTUM_LOOKBACK)
    condition_details['momentum_increasing'] = {
        'met': momentum_increasing,
        'details': {
    ...
    # Print details for this condition
    print(f"\nMomentum Increasing: {momentum_increasing}")
    print(f"Momentum Decreasing: {momentum_decreasing}")
    print(f"Condition Met: {momentum_increasing}")
...
def main():
    ...
    print("- Momentum > 0")
    print("- Momentum Increasing (last 5 values)")
    print("- FFT Up Cycle")
    print("="*60)
