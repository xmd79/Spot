...
# Updated configurable conditions - Now includes RSI Oversold Most Recent (15s)
CONFIG = {
    "conditions": {
        "rsi_oversold_most_recent": True,
        "rsi_oversold_most_recent_15s": True,  # New condition: RSI Oversold Most Recent (15s)
...
def perform_single_iteration_analysis(client):
    ...
    # Condition 12: Current Close Below SMA200 (1m)
    print("\n--- Condition 12: Current Close Below SMA200 (1m) ---")
    ...
    # Condition 14: Current Close Below SMA200 (15s)
    print("\n--- Condition 14: Current Close Below SMA200 (15s) ---")
