...
# Updated configurable conditions - Now 5 conditions (reduced from 9)
CONFIG = {
    "conditions": {
    ...
    "min_conditions_met": 5  # ALL 5 conditions must be met to trigger a trade
}
...
def perform_single_iteration_analysis(client):
    ...
    print("="*80)
    print(f"ENHANCED BTCUSDC TRADING BOT - 5 TRIGGERS")
    ...
    # Fetch FFT data for 5m timeframe
    ...
    print("\n2. Analyzing all 5 specified trading conditions...")
    
    conditions_met = 0
    total_conditions = 5  # Total number of conditions
    ...
    # Condition 4: FFT Forecast Up (5m)
    print("\n--- Condition 4: FFT Forecast Up (5m) ---")
    ...
    # Condition 5: Argmin More Recent (5m)
    print("\n--- Condition 5: Argmin More Recent (5m) ---")
    argmin_5m_met = False
...
def main():
    ...
    print("4. Execute trade if ALL 5 conditions are met")
    ...
    print("\nEnhanced Features:")
    print("- Now 5 selected triggers (reduced from 9)")
